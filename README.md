...
### Initialize [Render](https://github.com/kisrobot/render)

```go
import "github.com/kisrobot/render"
...
1. The template name. In this example [Render](https://github.com/kisrobot/render) will look up template `index.tmpl` from view paths. the default view path is `{current_repo_path}/app/views`, and you could register more view paths.
...
[Render](https://github.com/kisrobot/render) will find the layout at `{current_repo_path}/app/views/layouts/new_layout.tmpl`.

### Render with helper functions

Sometimes you may want to have some helper functions in your template. [Render](https://github.com/kisrobot/render) supports passing helper functions by `Funcs` function.
...
Put the [Render](https://github.com/kisrobot/render) inside [Responder](./responder.md) handle function like this.
